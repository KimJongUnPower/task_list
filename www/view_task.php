...
<body>
	...
	?>
	<content>
		<a href="http://<?=$_SERVER['HTTP_HOST']?>/view_project.php?id=<?=$project['id']?>" class="non-style-white"><p class="a-red">Смотреть проект</p></a>
	...
	<a class="non-style-white" href="http://<?=$_SERVER['HTTP_HOST']?>/delete_task.php?id=<?=$task['id']?>"><p class="title-p-black text-align-center">Удалить задание</p></a>
</body>
</html>