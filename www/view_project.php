...
<body>
		...
		<div class="width-1024px-non-background">
			...
			<div class="min-height-200px">
				...
				<form action="" method="POST" class="two-form-in-line">
					...
					<?php 
						include '../includes/view_users_in_project_on_select.php';
					?>
					</select>
	...
	<a class="non-style-white" href="http://<?=$_SERVER['HTTP_HOST']?>/delete_project.php?id=<?=$project['id']?>"><p class="title-p-black text-align-center">Удалить проект</p></a>
</body>
</html>
